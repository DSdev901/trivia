...
Mechanical clustering already ran. Cards that share a URL, a game, enough headline words, the same named people plus extra tokens, or the same person plus the same major event cue are already one item. What remains are leftovers: nearby cards whose headlines barely overlap.
