  ...
  ce.root.innerHTML = `
    <div class="ce-head">
      <div>
        ...
        <p class="lede">Netflix originals and entertainment from the last three weeks, plus ESPN
        sports headlines from the last two weeks — refreshed every few hours.</p>
      </div>
