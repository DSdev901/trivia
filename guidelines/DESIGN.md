...
|---|---|---|---|
| Display | Outfit 500/600/700 | Google Fonts / OFL | context |
...
- Hero / brand: Outfit 700, `clamp(2rem, 5vw, 2.75rem)`, tracking `-0.02em`
- Section titles: Outfit 700, ~1.45–1.85rem, tracking `-0.02em`
...
- Do not faux-bold. Do not outline Outfit. Do not set quiz questions in all-caps.

**Alternate (encoded, researched):** display = Source Sans 3 — closer to 90s webmaster, colder clubhouse. Default remains Outfit.
...
Shared core: paper, ink, Outfit, the General, quiz CTAs in ink.  
