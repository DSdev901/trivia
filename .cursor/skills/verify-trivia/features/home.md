...
Home is the category menu for General Trivia. The user sees the General badge, a themed-trivia ticker, category cards, a visitor counter, and 90s badges including a link to the style guidelines.
...
- `home-badges` includes Netscape, Sign the guestbook, Y2K, and Brand guidelines.
...
- **Badges.** Confirm a link named `Brand guidelines` and a link named `Sign the guestbook`.
